  ...
  <div class="creatorForm row">
    ...
    <div class="TestFormInfo ">
      ...
      <div class="row">
        <div class="col">
          <div class="form-floating">
            <select id="QPreset" class="form-select" v-model="newTest.preset" title="Quick Preset">
      ...
      <div class="row">
        <div class="col">
          ...
          <div class="form-floating">
            <select id="TSub" class="form-select" v-model="newTest.submission" title="Submission Mode">
